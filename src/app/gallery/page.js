...
const artworks = [
  {
    ...
    description:
      "Portrays a man in a bowler hat with his face obscured by a floating green apple, questioning identity, visibility, and hidden truths.",
  },
  {
    src: "/images/magritte4.png",
    title: "The Empire of Light (1954)",
    description:
      "Juxtaposes a bright daytime sky with a nighttime street scene, creating a paradox that challenges our sense of time and reality.",
  },
  {
    src: "/images/magritte3.png",
    title: "Golconda (1953)",
    description:
      "Depicts countless men in bowler hats floating in the sky, blending the ordinary with the surreal to reflect anonymity and repetition in modern life.",
  },
  {
    src: "/images/magritte16.png",
    title: "The Lovers (1928)",
    description:
      "Shows two lovers kissing with cloth covering their heads, symbolizing mystery, desire, and the barriers to true intimacy.",
  },
];
...
export default function GalleryScrollPage() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = containerRef.current.querySelectorAll(".artwork-section");
