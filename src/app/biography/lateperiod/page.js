        ...
        <div className="min-h-screen px-6 md:px-24 py-5 relative">
          ...
          >
            ...
            <p className="max-w-2xl text-gray-700 text-base md:text-lg font-light leading-relaxed">
             In the 1950s and 60s, Magritte gained international recognition. Though once seen as too literal, his blend of the ordinary with the mysterious found lasting influence. His work inspired pop artists like Warhol and Lichtenstein, and helped shape conceptual and postmodern art. Today, Magritte is celebrated for challenging perception and redefining the line between reality and illusion.
            </p>
          </motion.div>
